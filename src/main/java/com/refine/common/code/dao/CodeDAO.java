...
public interface CodeDAO {
    public static final Logger logger = LoggerFactory.getLogger(CodeDAO.class);

    public abstract List<Map<String, String>> getRfCodeByComClsCd(Map<String, Object> modelMap) throws SQLException;
    ...
    public abstract List<Map<String, String>> getDptList(Map<String, Object> modelMap) throws SQLException;
